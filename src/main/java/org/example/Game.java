            ...
            if (choice == 1) {
                ...
                while (choice != 1 && choice != 2) {
                    ...
                    if (choice == 1) {
                        ...
                        System.out.println("");
                        System.out.println("Chvíli přemýšlíš, jestli je tobrý nápad, ale pak se vzchopíš. Postavíš se před toho před tebou se sebevědomým výrazem ve tváři.");
                                    ...
                                    if (choice == 1) {
                                        ...
                                        while (choice != 1 && choice != 2) {
                                            ...
                                            if (choice == 1) {
                                                ...
                                                System.out.println("");
                                                System.out.println("Snažíš se nevnímat fakt, že scéna přesně odpovída tomu, jak to ve vozidle vypadá a pak... uvidíš na displeji sebe.");
                                                System.out.println("");
                                                System.out.println("1) ");
                                                System.out.println("2) ");
                                                System.out.println("");
